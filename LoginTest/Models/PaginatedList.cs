/*
 PaginatedList model class
 Author: Evgeny Chudaev
 Purpose: Represents the paginated list object
 */
...
namespace LoginTest.Models
{
    public class PaginatedList<T> : List<T>
    {
        ...
        // COnstructor for paginated list
        ...
        // method that checks existence of a previous page
        ...
        // method that checks existence of the next page
